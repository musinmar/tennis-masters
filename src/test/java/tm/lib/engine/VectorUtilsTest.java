...
public class VectorUtilsTest {
    ...
    public void testRotate() {
        ...
        Assert.assertTrue(VectorUtils.equalWithTolerance(actual1, expected1, TOLERANCE));
        
        Vector2D actual2 = VectorUtils.rotate(actual1, FastMath.toRadians(60));
        Vector2D expected2 = new Vector2D(0, 1);
        Assert.assertTrue(VectorUtils.equalWithTolerance(actual2, expected2, TOLERANCE));
        
        Vector2D actual3 = VectorUtils.rotate(actual2, FastMath.toRadians(45));
        Vector2D expected3 = new Vector2D(-0.707107, 0.707107);
        Assert.assertTrue(VectorUtils.equalWithTolerance(actual3, expected3, TOLERANCE));
    }
